      ...
      <form onSubmit={onSubmit}>
        ...
        <div className='flex'>
          ...
          <button type="button" id="type" value="rent"
            onClick={onChange} className={` ml-3px-7 py-3 font-medium
              text-sm uppercase shadow-md rounded hover:shadow-lg
              focus:shadow-lg active:shadow-lg
              transition duration-150 ease-in-out
              w-full ${
        ...
        <input type="text" id="name" value={name} 
          ...
          minLength="10" required className='w-full px-4 py-2 text-xl
        ...
        <textarea type="text" id="address" value={address} 
          onChange={onChange} placeholder='Address' required 
        ...
        <textarea type="text" id="description" value={description} 
          onChange={onChange} placeholder='Description' required 
          className='w-full px-4 py-2 text-xl
          text-gray-700 bg-white border border-gray-300 rounded
          transition duration-150 ease-in-out focus:text-gray-700 
          focus:bg-white focus:border-slate-600 mb-6' />
        ...
        <div className='mb-6'>
          ...
          <input type="file" id="images" onChange={onChange} accept='.jpg,.png,.jpeg' 
            ...
            focus:bd-white focus:border-slate-600'/>
        </div>
